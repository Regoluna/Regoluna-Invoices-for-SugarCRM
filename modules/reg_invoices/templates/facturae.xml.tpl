	...
	<Invoices>
      ...
      <!--{{/if}}-->
        ...
        <InvoiceLine>
          ...
          <!--{{if isset($i.retention.}}-->
          <TaxesWithheld>
            <Tax>
              <TaxTypeCode>{{$i.retention.TaxTypeCode}}</TaxTypeCode>
              <TaxRate>{{$i.retention.TaxRate}}</TaxRate>
              <TaxableBase>
                <TotalAmount>{{$i.retention.TaxableBase}}</TotalAmount>
              </TaxableBase>
              <TaxAmount>
                <TotalAmount>{{$i.retention.TaxAmount}}</TotalAmount>
              </TaxAmount>
            </Tax>
          </TaxesWithheld>
          <!--{{/if}}-->
