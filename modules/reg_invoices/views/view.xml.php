...
class reg_invoicesViewXml extends InvoiceView{
...
//    'TotalTaxesWithheld'=>'%01.6F',
  ...
  function display(){
    ...
    // Cabecera - FileHEader
    // ******************************
    $this->ss->assign("BatchIdentifier",$this->bean->number.'1');
    ...
    // subvenciones, anticipos y/o.retention.s que pudieran haberse practicado
    ...
    // los anticipos y sin tener en cuenta las.retention.s
    ...
    ob_clean();
    echo $this->ss->fetch('modules/reg_invoices/templates/facturae.xml.tpl');
  }
